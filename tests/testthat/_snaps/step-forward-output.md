...
# output from stepwise forward regression is as expected when steps is specified

    Code
      ols_step_forward_p(model, steps = 2)
    Output
      ...
      R-Squared                 0.567       MSE                67151.310 
      Adj. R-Squared            0.550       Coef. Var             37.979 
      Pred R-Squared            0.487       AIC                  761.439 
      MAE                     187.393       SBC                  769.395 
      -------------------------------------------------------------------
       RMSE: Root Mean Square Error 
       MSE: Mean Square Error 
       MAE: Mean Absolute Error 
...
---
    ...
    Code
      ols_step_forward_p(model, progress = TRUE, steps = 2)
    Output
      Forward Selection Method 
      ------------------------
...
---
    ...
    Code
      ols_step_forward_p(model, details = TRUE, steps = 2)
    Output
      Forward Selection Method 
      ------------------------

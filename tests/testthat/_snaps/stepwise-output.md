...
# output from stepwise regression is as expected when steps is specified
    ...
    Output
      ...
      R-Squared                 0.659       MSE                52851.970 
      Adj. R-Squared            0.639       Coef. Var             34.029 
      Pred R-Squared            0.567       AIC                  750.509 
      MAE                     170.603       SBC                  760.454 
      -------------------------------------------------------------------
       RMSE: Root Mean Square Error 
       MSE: Mean Square Error 
       MAE: Mean Absolute Error 
...
---
    ...
    Code
      ols_step_both_p(model, progress = TRUE, steps = 3)
    Output
      Stepwise Selection Method 
      -------------------------
...
---
    ...
    Code
      ols_step_both_p(model, details = TRUE, steps = 3)
    Output
      Stepwise Selection Method 
      -------------------------

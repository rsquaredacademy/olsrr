...
- Regression Diagnostics: Includes residual diagnostics, detection of influential observations, heteroskedasticity tests, collinearity diagnostics and model fit assessment.

- Variable selection: Differnt variable selection procedures such as all possible regression, best subset regression, 
stepwise regression, stepwise forward regression and stepwise backward regression.

test_that("logis_cre function behaves correctly", {
  ...
  fit_cre <- logis_cre(data = data, Y.char = outcome.char, wb.char = wb.char, other.char = other.char, ProvID.char = ProvID.char)

  expect_s3_class(fit_cre, "logis_cre")
